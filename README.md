...
```python3 AI_Anime_Girl_Generator.py``` 
...
The characters follow the TextGen format and the traits are all SFW. They will work right away after importing them into your favorite AI roleplay platform if it accepts the format.
